      ...
      <aside className="w-[232px] bg-[#995BD5] flex flex-col z-20 border-r border-white/20 relative overflow-hidden">
        ...
        <div className="h-16 flex items-center px-6 border-b border-white/10 relative z-10">
          <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <div>
              <h1 className="text-[14px] font-bold text-black tracking-tight leading-none">BrandedUK</h1>
              <p className="text-[10px] text-black/50 font-medium mt-1 uppercase tracking-wider">Admin</p>
            </div>
          </Link>
        </div>
          ...
          {sections.map((section) => (
            <div key={section.title} className="space-y-3">
              <div className="flex items-center gap-2 px-4 mb-3">
                ...
                <h3 className="text-[12px] font-bold text-black/60 uppercase tracking-[0.08em]">
                  {section.title}
                </h3>
              </div>
              <div className="space-y-1.5">
                {section.items.map((item) => {
                  ...
                  const activeStyles = "bg-black/10 text-black border-l-[3px] border-black shadow-[inset_10px_0_15px_-10px_rgba(0,0,0,0.1)]"
                  const inactiveStyles = "text-black/80 hover:bg-black/10 hover:text-black border-l-[3px] border-transparent"
                      ...
                      {hasSubItems ? (
                        <div className="flex flex-col">
                          ...
                          >
                            ...
                            >
                              <Icon className={`w-3.5 h-3.5 mr-3 flex-shrink-0 ${active ? 'text-black' : 'text-black/60 group-hover:text-black'}`} />
