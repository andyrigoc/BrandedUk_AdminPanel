                                ...
                                dayEvents.map(event => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-slate-400">{event.email} &middot; {event.items} items &middot; <span style={{ color: event.statusStyle.bg }} className="font-bold">{event.status}</span></p>
                                        </div>
